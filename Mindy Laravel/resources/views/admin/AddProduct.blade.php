    ...
    <div class="container-fluid" style="width: 850px;margin-left: 80px;">
        <form action="/product/add" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-7">
                <input type="text" class="form-control" name="paket" placeholder="Paket" value="{{ old('paket') }}">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" name="service" placeholder="Service" value="{{ old('service') }}" rows="3"></textarea>
                </div>
            </div>
